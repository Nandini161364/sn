from social.exceptions import InvalidUserException, InvalidPostException, InvalidReactionTypeException


class CreateReactToPostInteractor:
    ...
    def create_reaction(self, reaction_dto):
        ...
        if not self.storage.is_valid_post(reaction_dto.post_id):
